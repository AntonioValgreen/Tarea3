        ...
        if (isset($_REQUEST["letra"]) || isset($_POST["busqueda"])){
            ...
            if (isset($_REQUEST["borrar"])){
                if ($_REQUEST["borrar"] == "yes"){
                    echo '<div class="mensajeBorrar">El registro fue borrado de la base de datos</div>';
                }
            }
        ...
        <div class="contenedorRegistro" id="registro"> 
            ...
            <div class="registro">
                <div class="cerrar">
                    ...
                    <button type="button" onClick="borrarRegistro(<?php echo $id; ?>)"><i class="fas fa-trash"></i></button>
