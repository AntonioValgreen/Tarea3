        ...
        <form method = "post" action = "editarRegistro_xt.php" id="f2">
            ...
            <div class="modal-container"> 
                ...
                <div class="formulario">
                    <button type="button" class="botonFormularioModal" onClick="validarFormulario()">Ingresar</button>
                    
                    <button type="button" class="botonFormularioModal" onClick="cancelar(<?php echo $id; ?>)">Cancelar</button>
